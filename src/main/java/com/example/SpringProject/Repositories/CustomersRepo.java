...
public interface CustomersRepo extends JpaRepository<Customer, Integer> {
    ...
    /*
    List<Coupon> findByCustomerIDAndCategoryID(int customerID, Category categoryID);

    List<Coupon> findByCustomerIDAndLessThanMaxPrice(int customerID, double maxPrice);
