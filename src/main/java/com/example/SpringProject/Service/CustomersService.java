...
public interface CustomersService {
     ...
     */
    void purchaseCoupon(int customerID, int couponID) throws UserErrorException, CouponStockException;

    //void purchaseCouponsList(int customerID, List<Integer> couponsID) throws UserErrorException, CouponStockException;
     ...
     * @throws UserErrorException - When there is no customer with that id.
     */
    List<Coupon> getCustomerCouponsByCategory(int customerID, Category category) throws UserErrorException;
    ...
    int getCustomerId(String email, String password) throws UserErrorException;
}
