...
public interface CompaniesService {
     ...
     * @throws UserErrorException - The company does not exist in the data base.
     */
    List<Coupon> getCompanyCouponsByMaxPrice(int companyID, double maxPrice) throws UserErrorException;
     ...
     * @throws UserErrorException - The company does not exist in the data base.
     */
    List<Coupon> getCompanyCouponsByCategory(int companyID, Category category) throws UserErrorException;
     ...
     * @throws UserErrorException - The company does not exist in the data base.
     */
    Optional<Company> getCompanyDetails(int companyID) throws UserErrorException;

    int getCompanyId(String email, String password) throws UserErrorException;
}
