...
public interface CouponsRepo extends JpaRepository<Coupon, Integer> {
    /**
     * Gets one coupon from the DB by its company id and title.
     *
    ...
    /**
     * Gets one coupon from the DB by its company id and coupon id.
     *
     * @param companyId - The id of the company.
    ...
    /**
     * Deletes purchases records from the "company_coupons" table.
     *
